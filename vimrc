...
command! -bang BrowseProjects call fzf#run(fzf#wrap({'source':'command ls -d -1 ~/dotfiles ~/code/* ~/cthulhu/docode/src/do/teams/{compute,paas}/* ~/{,go/}src/{bou.ke,k8s.io,github.com/*}/* 2>/dev/null', 'options':'--tiebreak=length,begin,end'}))
